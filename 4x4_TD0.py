...
# Example 4X4-tuple network patterns for a 4x4 board.
patterns = [
...
def td_learning(env, approximator, num_episodes=50000, alpha=0.01, gamma=0.99,
                epsilon=0.01, save_interval=10000, save_dir="checkpoints"):
    """
...
final_scores = td_learning(env, approximator, num_episodes=150000, alpha=0.1, gamma=0.99, save_dir="4x4_TD0_per_move_update_checkpoints")
